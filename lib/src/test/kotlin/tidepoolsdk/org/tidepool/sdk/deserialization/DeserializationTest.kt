...
import org.tidepool.sdk.deserialization.defaultDeserializationException
...
class DeserializationTest {
	sealed class Sample(
		...
		enum class SampleSubtype(override val subclassType: KClass<out Sample>) : ResultType<Sample> {
