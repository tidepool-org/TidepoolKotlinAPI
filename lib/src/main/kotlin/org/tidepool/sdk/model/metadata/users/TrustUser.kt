...
open class TrustUser : User() {
    ...
    data class JsonPermissions(private val custodian: JsonObject? = null, private val view: JsonObject? = null, private val note: JsonObject? = null, private val upload: JsonObject? = null) {
